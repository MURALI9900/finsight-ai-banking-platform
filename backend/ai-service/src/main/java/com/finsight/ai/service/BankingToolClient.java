...
public class BankingToolClient {
 ...
 public List<Map<String,Object>> overdueLoans(int minimumDays){
  return client.get().uri("/api/v1/banking/loans/overdue?minimumDays={days}",minimumDays).retrieve().body(List.class);
 }
 public List<Map<String,Object>> failedTransactions(){
  return client.get().uri("/api/v1/banking/transactions/failed").retrieve().body(List.class);
 }
 public Map<String,Object> summary(){
  return client.get().uri("/api/v1/banking/summary").retrieve().body(Map.class);
 }
}